...
public class AppDemoController extends BaseController {
    ...
    public String list() {
        return "appdemo/appdemo/list";
    }

    @RequestMapping("/add.html")
    @PreAuthorize("hasAuthority('appdemo:appdemo:add')")
    public ModelAndView toAdd(ModelAndView mv) {
        mv.setViewName("appdemo/appdemo/add");
        return mv;
    }

    @GetMapping("/{id}.html")
    @PreAuthorize("hasAuthority('appdemo:appdemo:update')")
    public ModelAndView toUpdate(@PathVariable("id") String id, ModelAndView mv) {
        mv.setViewName("appdemo/appdemo/update");
    ...
    @RequestMapping("list")
    @PreAuthorize("hasAuthority('appdemo:appdemo:list')")
    ...
    @PreAuthorize("hasAuthority('appdemo:appdemo:delete')")
