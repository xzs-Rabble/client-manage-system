    ...
    <div class="layui-row layui-col-space15">
        <div class="layui-col-md12">
            <div class="layui-card">
                <@sec.authenticate grants="user:linkmane:list">
                ...
                <div class="layui-card-body">
                    ...
                    <script type="text/html" id="List-toolbar">
                        <div class="layui-btn-container">
                            <@sec.authenticate grants="user:linkmane:add">
...
<script type="text/javascript" src="${request.contextPath}/scripts/user/linkmane/list.js?_=${randomNum}"></script>
