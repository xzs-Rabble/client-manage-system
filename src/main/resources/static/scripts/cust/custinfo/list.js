layui.use(['form', 'layer', 'table', 'laytpl', 'laydate'], function () {
            ...
            {type: "checkbox", fixed: "left", width: 50},
                    ...
                    {field: 'openStatus', title: '经营状态', minWidth: 100, align: "center",templet: function (d) {
                            if (d.openStatus == '0') {
                                ...
                                return "<button class=\"layui-btn layui-btn-disabled layui-btn-xs sz-btn-sm\" style='cursor: default'>注销</button>";
                            } else if (d.openStatus == '2') {
                                return "<button class=\"layui-btn layui-btn-danger layui-btn-xs sz-btn-sm\" style='cursor: default'>破产</button>";
                            }
                        }},
    ...
    var $ = layui.$, active = {
        reload: function () {
            ...
            var selectedProvince = $("#searchForm").find("select[name='selectedProvince']").val().trim();
            //表格重载
            tableIns.reload({
