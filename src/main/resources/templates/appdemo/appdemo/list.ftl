    ...
    <div class="layui-row layui-col-space15">
        <div class="layui-col-md12">
            <div class="layui-card">
                <@sec.authenticate grants="appdemo:appdemo:list">
                ...
                <div class="layui-card-body">
                    ...
                    <script type="text/html" id="List-toolbar">
                        <div class="layui-btn-container">
                            <@sec.authenticate grants="appdemo:appdemo:add">
                    ...
                    <script type="text/html" id="List-editBar">
                        <@sec.authenticate grants="appdemo:appdemo:update">
                            <a class="layui-btn layui-btn-xs layui-btn-primary" lay-event="update"><i
                                        class="layui-icon">&#xe642;</i>修改</a>
                        </@sec.authenticate>
                        <@sec.authenticate grants="appdemo:appdemo:delete">
...
<script type="text/javascript" src="${request.contextPath}/scripts/appdemo/appdemo/list.js?_=${randomNum}"></script>
</body>
</html>
